...
def sendTweetUpdate(enabled, beerTemperature, roomTemperature, heaterOn):
    message = "Room is {0} °C. Beer is {1} °C. Ideal temperature is {2} °C. Heater is on: {3}. [{4}]".format(roomTemperature, beerTemperature, TARGET_TEMPERATURE, heaterOn, time.asctime())
